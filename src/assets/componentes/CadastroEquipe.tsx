...
interface CadastroEquipesProps {
  onCadastrar: (novaEquipe: any) => void;
  onFechar: () => void;
}

const CadastroEquipes: React.FC<CadastroEquipesProps> = ({ onCadastrar, onFechar }) => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    onCadastrar(novaEquipe);
  };

  return (
    <div className="overlay">
      <div className="form-container">
        <h2 className="form-title">Cadastrar Equipe</h2>
